...
"""This module provides a program-like generative function language. The
generative function interfaces are implemented for the objects in this language
using transformations applied via `Jaxpr` interpreters.
