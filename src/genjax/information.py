...
Some of these tools assume usage of `GenSP` to support estimating density
evaluations when the density in question is one produced by an inference
algorithm (see SDOS, for example).
"""
